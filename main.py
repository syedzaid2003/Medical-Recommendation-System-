...
sym_des = pd.read_csv(r"C:\Users\Syed Zaid\OneDrive\Desktop\New folder (2)\medicine recomendation system final\datasets\symtoms_df (1).csv")
precautions = pd.read_csv(r"C:\Users\Syed Zaid\OneDrive\Desktop\New folder (2)\medicine recomendation system final\datasets\precautions_df (1).csv")
workout = pd.read_csv(r"C:\Users\Syed Zaid\OneDrive\Desktop\New folder (2)\medicine recomendation system final\datasets\workout_df (1).csv")
description = pd.read_csv(r"C:\Users\Syed Zaid\OneDrive\Desktop\New folder (2)\medicine recomendation system final\datasets\description (2).csv")
medications = pd.read_csv(r"C:\Users\Syed Zaid\OneDrive\Desktop\New folder (2)\medicine recomendation system final\datasets\medications (1).csv")
diets = pd.read_csv(r"C:\Users\Syed Zaid\OneDrive\Desktop\New folder (2)\medicine recomendation system final\datasets\diets (1).csv")

# load model
svc = pickle.load(open(r"C:\Users\Syed Zaid\OneDrive\Desktop\New folder (2)\medicine recomendation system final\model\svc.pkl", 'rb'))
    ...
    if request.method == 'POST':
        ...
        if symptoms == "Symptoms":
            ...
            try:
                ...
                message = "Sorry, we couldn't find any matching symptoms in our database. Please try again!"
                return render_template('index.html', message=message)
